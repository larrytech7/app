...
@section('content')
<!-- Heading Row -->
        <div class="row center-align" > <!-- CLIENT LOGO HERE --><img src="{{Input::get('logo')}}" alt="Logo" class="responsive-img" width="200" height="100"/></div>
        <div class="row">
                    ...
                    <div class="card blue-grey darken-1 center-align">
                        ...
                        <ul class="collection">
                            ...
                            <li class="collection-item avatar">
                                ...
                                <input type="hidden" name="apikey" value="{{Input::get('apikey')}}"/>
                                <input type="hidden" name="amount" value="{{Input::get('amount')+0.5}}"/>
                                <input type="hidden" name="currency" value="{{Input::get('currency')}}"/>
