            ...
            <div class="col-md-8">
                <div class="col s12 m3 ">
                    <div class="collection" >
                        ...
                        <a class="collection-item blue active" href="{{URL::route('send')}}" >
                            <i class="material-icons left ">payment</i>Send payment
                        </a>
                ...
                <div class="col s12 m9 card grey lighten-4">
                    <div class="card-content">
                        <span class="card-title blue-text">New Transaction</span>
    			<!-- make a payment or send money -->
                      ...
                      {{Form::open(array('url'=>'payment', 'class'=>'form-horizontal payment', 'role'=>'form', 'onsubmit'=>'sendpayment(event)'))}}
                                ...
                                <div class="input-field col s12">
                                    <select class="pmode" name="mode" id="mode">
                                       ...
                                       <!-- <option value="sk" class="left circle">Skrill</option> -->
                                        <option value="mm" class="left circle">Mobile Money (MTN)</option>
                                       <!-- <option value="cc" class="left circle">Credit/Debit Card</option> -->
                                    </select>
                                    <label><i class="material-icons grey-text tooltiped" data-position="right" data-delay="50" data-tooltip="This is the method of transfer you want to use. Make sure you have a valid account with the provider">info</i>Sender Provider</label>
                          ...
                          <div class="col s12 m6">
                            ...
                            <div class="input-field col s12">
                                    ...
                                    <label><i class="material-icons grey-text tooltiped" data-position="right" data-delay="50" data-tooltip="This is the provider through which the receiver will receive the transfer. Make sure the receiver has a valid account with this provider.">info</i>Receiver Provider</label>
                             </div>
                             <div class="right">
